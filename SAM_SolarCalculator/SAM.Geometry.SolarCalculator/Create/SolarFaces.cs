...
namespace SAM.Geometry.SolarCalculator
{
    ...
    {
        public static List<SolarFace> SolarFaces(this SolarFace solarFace, Vector3D vector3D, IEnumerable<Polygon2D> polygon2Ds, Plane plane, double tolerance = Core.Tolerance.Distance)
        {
